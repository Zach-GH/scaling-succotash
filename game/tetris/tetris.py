...
A file that maintains the structure of the overall game.  Operations include
creating a grid for the tetrominos, creating the right-side menu, keeping
track of score, and maintaining key input within the game.
"""
